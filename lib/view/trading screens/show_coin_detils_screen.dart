...
import 'package:global_currency/widgets/small_container.dart';
...
class ShowCoinDetailsScreen extends StatefulWidget {
  var image;
  var price;
  var name;
  ShowCoinDetailsScreen(
      {super.key,
      required this.image,
      required this.price,
      required this.name});
  ...
  @override
  State<ShowCoinDetailsScreen> createState() => _ShowCoinDetailsScreenState();
}

class _ShowCoinDetailsScreenState extends State<ShowCoinDetailsScreen> {
            ...
            children: [
              ...
              SfCartesianChart(
                ...
                primaryYAxis: NumericAxis(
                    ...
                    opposedPosition: true, // Align value axis to the right side
              ...
              const Row(
                mainAxisAlignment: MainAxisAlignment.spaceAround,
                children: [SmallContainer(), SmallContainer()],
              )
            ],
          ),
        ),
